...
EndPoint* EndPointFactory::createSocketEndPointInstance(EndPointFactory::EndPointType endPointType, EndPoint::ProtocolType protocolType, EndPoint::SocketType socketType)
{
	/*switch (endPointType)
	{
	case IPC_UDS:
		return new UnixDomainSocket(protocolType, socketType);
		break;
	}*/
	return 0;
}
