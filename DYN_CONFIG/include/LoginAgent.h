...
/**************************************************************************************
	Function name	: login
	Description 	: This method is used to login to the database. It requires a tag name as input. 
			  The method retrieves the database details from the encrypted file and uses them to login to the database.
	Scope		: public
	
	Parameters	: tagName – The tag name used to fetch the database credentials from an encrypted file
	Return type	: void
******************************************************************************************/
